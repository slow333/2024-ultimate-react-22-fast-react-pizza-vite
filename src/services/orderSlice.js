          ...
          return pizza.quantity === 0
            ? null
              : pizza.pizzaId === action.payload.pizzaId
                ? {...pizza, quantity: action.payload.selectedQty, totalPrice: action.payload.selectedQty * pizza.unitPrice}
            : pizza;
          // return pizza.pizzaId === action.payload.pizzaId && pizza.quantity === 0
          //   ? {}
          //   : pizza.quantity > 0
          //     ? {...pizza, quantity: action.payload.selectedQty}
          //     : pizza;
        })
      }
    }
...
export const {addCustomer, addCart, addPhone, addAddress,incQuantity, decQuantity,setQuantity} = orderSlice.actions;
